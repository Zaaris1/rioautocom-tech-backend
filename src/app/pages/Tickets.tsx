...
export default function TicketsPage() {
  ...
  return (
    <div className="grid tickets-page">
        ...
        >
          <div style={{ minWidth: 240, flex: "0 0 auto" }}>
            ...
            {role === "CLIENT" && clientSummary && (
              <div
                className="tickets-summary-grid"
                style={{
                  marginTop: 12,
                  display: "grid",
            ...
            {role !== "CLIENT" && (
              <div className="tickets-summary-grid" style={{ marginTop: 12, display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(4, minmax(140px, 1fr))", gap: 10 }}>
          ...
          <div className="tickets-filter-panel" style={rightPanel}>
            <div className="tickets-filter-row tickets-filter-row--search" style={{ ...rowWrap, justifyContent: "flex-start" }}>
              <input
                className="input"
            ...
            <div className="chips tickets-filter-status" style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-start" }}>
            ...
            {role === "CLIENT" && (
              <div className="tickets-filter-row tickets-filter-row--period" style={rowWrap}>
                <div className="small" style={{ opacity: 0.85 }}>
                  Período:
                </div>
            ...
            {role === "ADMIN" && (
              <div className="tickets-filter-row tickets-filter-row--options" style={rowWrap}>
                <label style={{ display: "flex", alignItems: "center", gap: 8, margin: 0 }}>
            ...
            <div className="tickets-filter-row tickets-filter-row--dates" style={rowWrap}>
              <div className="small" style={{ opacity: 0.85 }}>
                Data:
              </div>
            ...
            <div className="small tickets-filter-summary" style={{ textAlign: "left", opacity: 0.9 }}>
      ...
      <div className="col-12 card page-section-card">
        ...
        {loading ? (
          <div className="small">Carregando chamados...</div>
        ) : tickets.length === 0 ? (
