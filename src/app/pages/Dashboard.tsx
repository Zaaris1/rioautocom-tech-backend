...
export default function DashboardPage() {
  ...
  const quickActions = React.useMemo(() => {
    const base = [
      { to: "/tickets", label: "Chamados", hint: "Abrir backlog e atendimentos em andamento.", icon: "🎫" },
      ...
      <div className="dashboard-grid">
        <div className="dashboard-main">
          <div className="card page-section-card">
            ...
            <div className="dashboard-summary-grid">
              <div className="page-soft-card dashboard-summary-card">
                ...
                <div className="small dashboard-summary-copy">Situação das lojas monitoradas no momento.</div>
              </div>
          ...
          <div className="card page-section-card">
            <div className="page-section-head">
              <div>
                <h2 className="page-section-title">Chamados que pedem ação</h2>
              ...
              <div className="page-soft-card">
                ...
                <div className="small">
                  {monitorSummary.attention > 0
                    ...
                    ? "Priorize chamados vencidos, próximos do prazo, urgentes ou pendentes."
